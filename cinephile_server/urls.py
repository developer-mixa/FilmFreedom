...
from cinephile_server.views import main_page, films_page, cinemas_page, film_detail_page, cinema_detail_page
...
urlpatterns = [
    ...
    path('cinemas/<uuid:pk>/', cinema_detail_page, name='cinema'),
]